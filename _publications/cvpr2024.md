...
description: "This CVPR 2024 paper studies general robustness verification of MaxPool-based convolutional neural networks via tighter linear approximation."
excerpt: "Robustness verification of MaxPool-based convolutional neural networks via tighter linear approximation."
citation_authors:
    - Yuan Xiao
    - Shiqing Ma
    - Juan Zhai
