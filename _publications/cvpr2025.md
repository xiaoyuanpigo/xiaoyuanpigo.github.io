...
description: "This CVPR 2025 paper presents Ti-Lin, a verifier for MaxPool-based neural networks using tight linear approximation."
excerpt: "Ti-Lin verifies MaxPool-based neural networks via tight linear approximation."
citation_authors:
    - Yuan Xiao
    - Yuchen Chen
    - Shiqing Ma
